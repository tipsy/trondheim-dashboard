...
class WeatherHour extends HTMLElement {
    ...
    getWeatherIcon(symbolCode) {
        ...
        // Material Design Icons (MDI) from Pictogrammers
        const icons = {
            clearsky: `<svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
            ...
            partlycloudy: `<svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
            ...
            cloudy: `<svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
            ...
            rain: `<svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
            ...
            snow: `<svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
            ...
            fog: `<svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
            ...
            thunder: `<svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
